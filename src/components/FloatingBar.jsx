  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-[#181818] text-white px-4 py-2 rounded-full flex items-center gap-4 shadow-lg border border-gray-700">
      ...
      <div className="flex items-center gap-3 text-gray-400 text-xl">
        <a href="https://github.com/mayank543" target="_blank" rel="noopener noreferrer" className="hover:text-white">
          <FaGithub />
        </a>
        <a href="https://x.com/d_mayank05" target="_blank" rel="noopener noreferrer" className="hover:text-white">
          <FaXTwitter />
        </a>
        <a href="https://www.linkedin.com/in/mayank-doholiya/" target="_blank" rel="noopener noreferrer" className="hover:text-white">
          <FaLinkedin />
        </a>
